        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#login">Edit Profil</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="user.php?hal=edit&id=<?= $data['NIK'] ?>" class="btn btn-warning">Edit</a>
                    ...
                    <table class="table table-dark table-hover">
                        ...
                        while ($data = mysqli_fetch_array($tampil)):
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <!-- Mengganti empat digit terakhir dari NIK menjadi **** -->
                                    <td>
                                        <?= str_repeat('*', strlen($data['NIK']) - 4) . substr($data['NIK'], -4); ?>
                                    </td>
                                    <td>
                                        <?= $data['nama'] ?>
                                    </td>
                                    ...
                                    <td>
                                        <?= str_repeat('*', strlen($data['nomor_telepon']) - 2) . substr($data['nomor_telepon'], -4); ?>
                                    </td>
                                    <td>
                                        <a href="user.php?hal=edit&id=<?= $data['NIK'] ?>" class="btn btn-warning">Edit</a>
