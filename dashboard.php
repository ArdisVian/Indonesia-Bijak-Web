...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  active" href="dashboard/pages/dashboard.html">
                        <div
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                <div class="full-background"
                    style="background-image: url('dashboard/assets/img/curved-images/white-curved.jpg')">
                </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
              ...
              <input type="text" class="form-control" placeholder="Type heredashboard.">
            </div> -->
                    </div>
        ...
        <div class="col-lg-7 mb-lg-0 mb-4">
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
              style="background-image: url('dashboard/assets/img/ivancik.jpg');">
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tnama" value="<?= $vnama ?>"
                                                    class="form-control" placeholder="Nama">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Tempat Lahir</label>
                                                <input type="text" name="tlahir" value="<?= $vtlahir ?>"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <input type="radio" id="laki-laki" name="tjenis_kelamin"
                                                        value="laki-laki" class="form-check-input"
                                                        <?= ($vj_k == 'laki-laki') ? 'checked' : '' ?>>
                                                    <label for="laki-laki" class="form-check-label">laki-laki</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="perempuan" name="tjenis_kelamin"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tagama" class="form-select">
                                                    ...
                                                    <option value="Islam" <?= ($vagama == 'Islam') ? 'selected' : '' ?>>
                                                        Islam</option>
                                                    <option value="Kristen" <?= ($vagama == 'Kristen') ? 'selected' : '' ?>>Kristen
                                                    </option>
                                                    <option value="Katolik" <?= ($vagama == 'Katolik') ? 'selected' : '' ?>>Katolik
                                                    </option>
                                                    <option value="Hindu" <?= ($vagama == 'Hindu') ? 'selected' : '' ?>>
                                                        Hindu</option>
                                                    <option value="Buddha" <?= ($vagama == 'Buddha') ? 'selected' : '' ?>>
                                                        Buddha
                                                    </option>
                                                    <option value="Konghucu" <?= ($vagama == 'Konghucu') ? 'selected' : '' ?>>Konghucu
                                                    </option>
                                                    <option value="Kepercayaan Lain" <?= ($vagama == 'Kepercayaan Lain') ? 'selected' : '' ?>>
                                                        Kepercayaan
                                                        Lain</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="talamat" value="<?= $valamat ?>"
                                                    class="form-control" placeholder="Masukkan alamat lengkap Anda">
                                            </div>
                                            ...
                                            <div class="text-center">
                                                <hr>
                                                <button class="btn btn-primary" name="bsimpan"
                                                    type="submit">Simpan</button>
                                                <button class="btn btn-danger" name="bkosongkan"
                                                    type="reset">Kosongkan</button>
                                            </div>
                                    ...
                                    while ($data = mysqli_fetch_array($tampil)):
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="dashboard.php?hal=edit&id=<?= $data['NIK'] ?>"
                                                        class="btn btn-warning">Edit</a>
                                                    <a href="dashboard.php?hal=hapus&id=<?= $data['NIK'] ?>"
